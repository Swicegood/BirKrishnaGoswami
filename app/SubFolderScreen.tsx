...
const images = {
  ...
  BKG_and_Sita_CD: require('../assets/images/Music.jpg'),
  Goloka_Album_I: require('../assets/images/Music.jpg'),
  Goloka_Album_II: require('../assets/images/Music.jpg'),
  Gopinath: require('../assets/images/Music.jpg'),
  Govinda_Gopal: require('../assets/images/Music.jpg'),
  Laugh: require('../assets/images/Laugh.jpg'),
